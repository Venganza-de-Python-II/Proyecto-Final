...
export function FormularioTaller({ valorInicial = {}, onSubmit = () => {}, textoBoton = "Guardar" }: Props) {
  // Usar una referencia para rastrear si es la primera renderización
  ...
  // Validación para asegurar que el rating esté entre 0 y 5
  ...
  // Validación para asegurar que el cupo sea un número positivo y no exceda el máximo
  ...
  // Actualizar el estado del formulario desde props solo en la renderización inicial o cuando valorInicial cambia realmente
  useEffect(() => {
